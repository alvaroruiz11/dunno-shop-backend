  ...
  departments: [
    {
      ...
      provinces: [
        {
          name: 'CERCADO',
          cities: [{ name: 'TRINIDAD' }],
        },
        {
          name: 'VACA DIEZ',
          cities: [{ name: 'GUAYARAMERIN' }, { name: 'RIBERALTA' }],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      provinces: [
        {
          name: 'CARRASCO',
          cities: [{ name: 'ENTRE RIOS' }],
        },
        {
          name: 'CERCADO',
          cities: [{ name: 'COCHABAMBA' }],
        },
        {
          name: 'CHAPARE',
          cities: [{ name: 'SACABA' }, { name: 'VILLA TUNARI' }],
        },
        {
          name: 'GERMAN JORDAN',
          cities: [{ name: 'CLIZA' }],
    ...
    },
    {
      ...
      provinces: [
        ...
        {
          name: 'GERMAN BUSCH',
          cities: [{ name: 'PUERTO QUIJARRO' }],
        },
        {
          name: 'GUARAYOS',
          cities: [{ name: 'EL PUENTE' }],
        },
        {
          name: 'ICHILO',
          cities: [{ name: 'YAPACANI' }],
        },
        {
        ...
        {
          name: 'VALLEGRANDE',
          cities: [{ name: 'VALLEGRANDE' }],
        },
        {
          name: 'VELASCO',
          cities: [{ name: 'SAN IGNACIO DE VELASCO' }],
        },
        {
          name: 'WARNES',
          cities: [{ name: 'WARNES' }],
    ...
    },
    {
      ...
      provinces: [
        ...
        {
          name: 'GRAN CHACO',
          cities: [{ name: 'VILLAMONTES' }, { name: 'YACUIBA' }],
        },
      ],
    },
  ],
